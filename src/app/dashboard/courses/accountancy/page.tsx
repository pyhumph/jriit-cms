...
const PAGE_NAME = 'accountancy'
const COURSE_NAME = 'Accountancy'
...
export default function AccountancyFinancePage() {
        ...
        if (missingComponents.length > 0 && session?.user?.id) {
          const createPromises = missingComponents.map(async (componentName) => {
            ...
            if (componentName === 'header') {
              defaultData.title = 'Accountancy'
              defaultData.subtitle = 'Finance'
              defaultData.content = 'Count. Analyze. Succeed.'
            } else if (componentName === 'career-skills') {
              defaultData.title = 'ACCOUNTING-READY SKILLS? CHECK.'
              defaultData.content = "In Accountancy at JRIIT, you'll master financial accounting, auditing, taxation, and financial management. Our program covers accounting principles, financial reporting, cost accounting, and business law. These are the skills that make JRIIT accounting graduates highly valued in finance and business sectors.\n\nWhy? We emphasize practical accounting scenarios and real-world financial analysis. You'll receive detailed feedback on your accounting skills and financial analysis techniques, giving you a complete understanding of your professional growth.\n\nDiscover our accountancy programs below and unlock the skills to excel in finance."

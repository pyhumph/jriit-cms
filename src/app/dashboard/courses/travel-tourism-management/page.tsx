...
const PAGE_NAME = 'travel-tourism-management'
const COURSE_NAME = 'Travel & Tourism'
        ...
        if (missingComponents.length > 0 && session?.user?.id) {
          const createPromises = missingComponents.map(async (componentName) => {
            ...
            if (componentName === 'header') {
              defaultData.title = 'Travel &'
              defaultData.subtitle = 'Tourism'
              defaultData.content = 'Explore. Discover. Journey.'
            } else if (componentName === 'career-skills') {
              defaultData.title = 'TOURISM-READY SKILLS? CHECK.'
              defaultData.content = "In Travel & Tourism Management at JRIIT, you'll gain expertise in hospitality, travel planning, destination management, and customer service. Our program covers tourism marketing, event management, cultural tourism, and sustainable tourism practices. These are the skills that make JRIIT tourism graduates excel in the global hospitality industry.\n\nWhy? We emphasize hands-on experience with real-world tourism scenarios. You'll receive detailed feedback on your customer service skills and tourism management strategies, giving you a complete understanding of your professional development.\n\nDiscover our tourism programs below and unlock the skills to create memorable travel experiences."

...
const PAGE_NAME = 'computer-science'
        ...
        if (missingComponents.length > 0 && session?.user?.id) {
          const createPromises = missingComponents.map(async (componentName) => {
            ...
            if (componentName === 'header') {
              ...
              defaultData.subtitle = 'Science'
              defaultData.content = 'Code. Innovate. Transform.'
            } else if (componentName === 'career-skills') {
              defaultData.title = 'CS-READY SKILLS? CHECK.'
              defaultData.content = "In Computer Science at JRIIT, you'll master fundamental programming concepts, algorithms, data structures, and software engineering principles. Our program covers software development, database systems, artificial intelligence, and computer networks. These are the skills that make JRIIT computer science graduates leaders in technology innovation.\n\nWhy? We emphasize practical coding projects and real-world software development. You'll receive detailed feedback on your programming skills and problem-solving approaches, giving you a comprehensive understanding of your technical growth.\n\nDiscover our computer science programs below and unlock the skills to build the future."

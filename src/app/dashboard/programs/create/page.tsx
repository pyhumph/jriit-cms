      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-gray-500">The course category this program belongs to</p>
          </div>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              placeholder="Prerequisites and admission requirements..."
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              placeholder='{"modules": ["Module 1", "Module 2"], "learningItems": [...]}'
            />
            <p className="mt-1 text-xs text-gray-500">Store modules and learning items as JSON</p>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              placeholder="Career paths and opportunities..."
            />
          </div>
        </div>

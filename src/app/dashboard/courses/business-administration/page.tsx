...
const PAGE_NAME = 'business-administration'
const COURSE_NAME = 'Business Administration'
        ...
        if (missingComponents.length > 0 && session?.user?.id) {
          const createPromises = missingComponents.map(async (componentName) => {
            ...
            if (componentName === 'header') {
              defaultData.title = 'Business'
              defaultData.subtitle = 'Administration'
              defaultData.content = 'Lead. Manage. Succeed.'
            } else if (componentName === 'career-skills') {
              defaultData.title = 'BUSINESS-READY SKILLS? CHECK.'
              defaultData.content = "In Business Administration at JRIIT, you'll develop essential management and leadership skills needed for success in today's competitive business environment. Our program covers strategic planning, financial management, marketing, human resources, and entrepreneurship. These are the skills that make JRIIT business graduates stand out in the corporate world.\n\nWhy? We emphasize practical, real-world business scenarios instead of traditional letter grades. You'll receive detailed feedback on your business strategies and management approaches, giving you a comprehensive understanding of your professional growth.\n\nDiscover our business programs below and unlock the skills to lead and succeed."

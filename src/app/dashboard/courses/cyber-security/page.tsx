...
const COURSE_NAME = 'Cyber Security'
        ...
        if (missingComponents.length > 0 && session?.user?.id) {
          const createPromises = missingComponents.map(async (componentName) => {
            ...
            if (componentName === 'header') {
              defaultData.title = 'Cyber'
              defaultData.subtitle = 'Security'
              defaultData.content = 'Protect. Defend. Secure.'
            } else if (componentName === 'career-skills') {
              defaultData.title = 'CYBER-READY SKILLS? CHECK.'
              defaultData.content = "In Cyber Security at JRIIT, you'll gain expertise in protecting digital systems, networks, and data from cyber threats. Our comprehensive program covers ethical hacking, network security, cryptography, and incident response. These are the skills that make JRIIT cybersecurity graduates highly sought after in today's digital landscape.\n\nWhy? We emphasize hands-on learning with real-world scenarios. You'll receive detailed feedback on your security assessments and defensive strategies, giving you a complete understanding of your capabilities.\n\nDiscover our cybersecurity programs below and unlock the skills to protect the digital world."

...
const PAGE_NAME = 'professional-course'
const COURSE_NAME = 'Professional Course'
        ...
        if (missingComponents.length > 0 && session?.user?.id) {
          const createPromises = missingComponents.map(async (componentName) => {
            ...
            if (componentName === 'header') {
              defaultData.title = 'Professional'
              defaultData.subtitle = 'Course'
              defaultData.content = 'Excel. Advance. Succeed.'
            } else if (componentName === 'career-skills') {
              defaultData.title = 'PROFESSIONAL-READY SKILLS? CHECK.'
              defaultData.content = "In Professional Courses at JRIIT, you'll gain specialized skills and industry-recognized certifications to advance your career. Our programs cover advanced training in various professional fields, industry best practices, and practical expertise. These are the skills that make JRIIT professional course graduates highly valued in their respective industries.\n\nWhy? We emphasize hands-on professional training and real-world industry scenarios. You'll receive detailed feedback on your professional skills and career development, giving you a complete understanding of your professional advancement.\n\nDiscover our professional courses below and unlock the skills to excel in your career."

...
const PAGE_NAME = 'information-technology'
        ...
        if (missingComponents.length > 0 && session?.user?.id) {
          ...
          const createPromises = missingComponents.map(async (componentName) => {
            ...
            if (componentName === 'header') {
              defaultData.title = 'Information'
              defaultData.subtitle = 'Technology'
              defaultData.content = 'Innovate. Create. Transform.'
            } else if (componentName === 'career-skills') {
              defaultData.title = 'TECH-READY SKILLS? CHECK.'
              defaultData.content = "In Information Technology at JRIIT, you'll get an education built on 10 core programs, which are vital for success in today's digital age — technical expertise in coding, networking, cybersecurity, and more. These are the skills that employers say make JRIIT IT graduates stand out. Our Information Technology program offers both a 1-year Certificate for foundational skills and a 2-year Diploma for advanced specialization in cutting-edge technologies.\n\nWhy? We emphasize hands-on learning instead of traditional letter grades. In every course, you'll receive detailed feedback on your technical strengths and where you can improve, giving you a more complete picture of your growth.\n\nDiscover our IT programs below and unlock the skills to shape your future."
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading Information Technology page...</p>
        </div>
      </div>
    )
  }
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Information Technology Page</h1>
            <p className="text-gray-600 mt-1">Manage content for the Information Technology course page</p>
          </div>
          {dirtyIds.size > 0 && (
            <button
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
        <div className="flex items-start space-x-3">
          ...
          <div>
            <h3 className="text-lg font-semibold text-blue-900 mb-2">Programs Management</h3>
            <p className="text-blue-800 mb-3">
              The <strong>program cards</strong> displayed on the Information Technology frontend page show individual programs (like "Computer Hardware", "Software", etc.). These programs are created and managed in the{' '}
            ...
            <ol className="list-decimal list-inside text-blue-800 mb-3 space-y-1 ml-2">
              ...
              <li>Assign the program to the "Information Technology" department</li>
              <li>The program will automatically appear on the Information Technology frontend page</li>
            </ol>

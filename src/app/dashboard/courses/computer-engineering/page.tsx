...
const PAGE_NAME = 'computer-engineering'
const COURSE_NAME = 'Computer Engineering'
        ...
        if (missingComponents.length > 0 && session?.user?.id) {
          const createPromises = missingComponents.map(async (componentName) => {
            ...
            if (componentName === 'header') {
              defaultData.title = 'Computer'
              defaultData.subtitle = 'Engineering'
              defaultData.content = 'Design. Build. Engineer.'
            } else if (componentName === 'career-skills') {
              defaultData.title = 'ENGINEERING-READY SKILLS? CHECK.'
              defaultData.content = "In Computer Engineering at JRIIT, you'll learn to design and develop computer systems, embedded systems, and hardware-software integration. Our program covers digital systems design, microprocessors, computer architecture, and system programming. These are the skills that make JRIIT engineering graduates excel in hardware and software development.\n\nWhy? We emphasize hands-on engineering projects and system design. You'll receive detailed feedback on your engineering solutions and technical designs, giving you a complete understanding of your engineering capabilities.\n\nDiscover our engineering programs below and unlock the skills to engineer innovative solutions."
